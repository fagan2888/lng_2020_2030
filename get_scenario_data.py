...
# definitions of standard scenarios (may also specify --inputs-dir or --inputs-subdir to read in alternative data)

# scenario_list = [
#     '# note: the options specified here override defaults set in options.txt',
#     '--scenario-name 100_biofuel_0_dr --biofuel_limit 1.00',
#     '--scenario-name 5_biofuel_0_dr',
#     '--scenario-name 5_biofuel_hydrogen_0_dr --include-module hawaii.hydrogen',
#
#     '--scenario-name 5_biofuel_hydrogen_30_dr --demand-response-share 0.3',
#     '--scenario-name 100_biofuel_30_dr --biofuel_limit 1.00 --demand-response-share 0.3',
#     '--scenario-name 5_biofuel_30_dr --demand-response-share 0.3',
# ]
#
...
for a in alt_args:
    ...
    # modify generator_info.tab to use 10-year project life for new thermal plants
    # (to study risk-averse decision making)
    print "Changing project life for thermal plants in generator_info.tab to 10 years."
    for line in fileinput.input(os.path.join(args['inputs_dir'], 'generator_info.tab'), inplace=True):
        print line.replace('CC_152\t152.0\t30.0', 'CC_152\t152.0\t10.0'
            ).replace('CC_383\t383.0\t30.0', 'CC_383\t383.0\t10.0'
            ).replace('CT_100\t100.0\t30.0', 'CT_100\t100.0\t10.0'),
